...
import utils.embedding_api as embedding_api
import random

data_path='./new_exp_fr/classifier/'
class NNModel:
    def __init__(self, embedding, mode, model_path=None, vocab_hash=None):
        ...
        self.save_dir='./new_exp_fr/classifier/model/'
...
def all_prepro():
    train_inf_src=['./new_exp_fr/classifier/informal.train.tok.bpe']
    train_fm_src = ['./new_exp_fr/classifier/formal.train.tok.bpe']
    val_inf_src = ['./new_exp_fr/classifier/informal.val.tok.bpe']
    val_fm_src = ['./new_exp_fr/classifier/formal.val.tok.bpe']
    test_inf_src = ['./new_exp_fr/classifier/informal.test.tok.bpe']
    test_fm_src = ['./new_exp_fr/classifier/formal.test.tok.bpe']
