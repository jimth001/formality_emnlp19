...
if __name__=='__main__':
    re=get_default_resources(domain='em')
    bleu_result=evaluate_bleu(re)
    #formality_result=evaluate_formality(re)
    #meaning_result=evaluate_meaning(re)
    #pinc_result = evaluate_pinc(re)
    print_dict(bleu_result)
    #print_dict(formality_result)
    #print_dict(meaning_result)
